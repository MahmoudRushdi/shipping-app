  ...
  return (
    <LanguageProvider>
      <Routes>
        ...
        <Route path="/customers" element={<ProtectedRoute allowedRoles={['admin', 'employee']}><CustomersManagementPage /></ProtectedRoute>} />
        <Route path="/debts" element={<ProtectedRoute allowedRoles={['admin', 'employee']}><DebtsManagementPage /></ProtectedRoute>} />
